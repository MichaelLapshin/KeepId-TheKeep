...
const std::string KAFKA_URL = "localhost"; // maybe "127.0.0.1"
const std::string KAFKA_URLPORT = "localhost:9093"; // maybe "127.0.0.1:9093"
...
const std::string CASSANRDA_URL = "localhost"; // maybe "127.0.0.1"
